...
const TRANSLATIONS = {
  en: {
    ...
    hero_sub:         'Connect with certified tourist guides across the Sultanate of Oman. Verified licences. Genuine experiences. Instant booking.',
  ...
  ar: {
    ...
    hero_sub:         'تواصل مع مرشدين سياحيين معتمدين في جميع أنحاء سلطنة عُمان. تراخيص موثّقة. تجارب حقيقية. حجز فوري.',
    search_dest:      'الوجهة',
